    ...
    public static ComputerDto mapFromEntity(Computer computer) {
        ...
        for(ComputerOffer computer_offer: ComputerOffers){
            ...
            if (offer.getItem().getProcessor() != null){
              componentDtos.add(ComponentDto.fromProcessor(offer.getItem().getProcessor(), offer));
            } else if (offer.getItem().getGraphicsCard() != null) {
                componentDtos.add(ComponentDto.fromGraphicsCard(offer.getItem().getGraphicsCard(), offer));
            } else if (offer.getItem().getMotherboard() != null) {
                componentDtos.add(ComponentDto.fromMotherboard(offer.getItem().getMotherboard(), offer));
            } else if (offer.getItem().getMemory() != null) {
                componentDtos.add(ComponentDto.fromMemory(offer.getItem().getMemory(), offer));
            } else if (offer.getItem().getStorage() != null) {
                componentDtos.add(ComponentDto.fromStorage(offer.getItem().getStorage(), offer));
            } else if (offer.getItem().getPowerSupply() != null) {
                componentDtos.add(ComponentDto.fromPowerSupply(offer.getItem().getPowerSupply(), offer));
            } else if (offer.getItem().getCase_() != null) {
                componentDtos.add(ComponentDto.fromCase(offer.getItem().getCase_(), offer));
            } else if (offer.getItem().getCooler() != null) {
                componentDtos.add(ComponentDto.fromCooler(offer.getItem().getCooler(), offer));
            }
        }
